...
module.exports = {
    ...
    output: {
        ...
        filename: 'utils.js', //打包之后生成的文件名，可以随意写。

        library: 'utils7js', // 指定类库名,主要用于直接引用的方式(比如使用script 标签)

        // libraryExport: "default", // [export default 导出时]对外暴露default属性，就可以直接调用default里的属性
